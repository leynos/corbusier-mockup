...
task-state-draft = Entwurf
task-state-in-progress = In Bearbeitung
task-state-in-review = In Prüfung
task-state-paused = Pausiert
task-state-done = Erledigt
task-state-abandoned = Abgebrochen
...
dashboard-health-degraded = BEEINTRÄCHTIGT
...
dashboard-agent-active = Aktiv
dashboard-agent-inactive = Inaktiv
