...
task-state-draft = 草稿
task-state-in-progress = 进行中
task-state-in-review = 审核中
task-state-paused = 已暂停
task-state-done = 已完成
task-state-abandoned = 已放弃
...
dashboard-health-degraded = 降级
dashboard-health-critical = 严重
...
dashboard-agent-active = 活跃
dashboard-agent-inactive = 闲置
