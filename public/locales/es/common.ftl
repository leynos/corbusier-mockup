...
task-state-draft = Borrador
task-state-in-progress = En curso
task-state-in-review = En revisión
task-state-paused = Pausada
task-state-done = Completada
task-state-abandoned = Abandonada
...
dashboard-health-degraded = DEGRADADO
...
dashboard-agent-active = Activo
dashboard-agent-inactive = Inactivo
dashboard-agent-turns = turnos
