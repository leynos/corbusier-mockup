...
task-state-draft = مسودة
task-state-in-progress = قيد التنفيذ
task-state-in-review = قيد المراجعة
task-state-paused = متوقفة مؤقتاً
task-state-done = منجزة
task-state-abandoned = مهجورة
...
dashboard-health-degraded = متدهور
...
dashboard-agent-active = نشط
dashboard-agent-inactive = غير نشط
