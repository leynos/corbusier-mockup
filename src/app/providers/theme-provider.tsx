...
const STORAGE_KEY = "corbusier-mockup.theme";
const DEFAULT_THEME = "corbusier-mockup-night";
const AVAILABLE_THEMES = ["corbusier-mockup-night", "corbusier-mockup-day"] as const;
 ...
 *   return (
 *     <button onClick={() => setTheme(theme === "corbusier-mockup-night" ? "corbusier-mockup-day" : "corbusier-mockup-night")}>
 *       Switch theme
 *     </button>
 *   );
 * }
